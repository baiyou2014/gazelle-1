...
<head>
  ...
  <link rel="search" type="application/opensearchdescription+xml"
    title="<?=SITE_NAME?>"
    href="<?=STATIC_SERVER?>opensearch.xml">
...
?>
  ...
  <link rel="stylesheet"
    href="<?=STATIC_SERVER?>styles/tooltipster/style.css?v=<?=filemtime(SERVER_ROOT.STATIC_SERVER.'styles/tooltipster/style.css')?>"
...
foreach ($ExtraCSS as $CSS) {
  ...
  <link rel="stylesheet" type="text/css" media="screen"
    href="<?=STATIC_SERVER."styles/$CSS/style.css?v=".filemtime(SERVER_ROOT.STATIC_SERVER."styles/$CSS/style.css")?>">
  <?php
}
...
foreach ($Scripts as $Script) {
  ...
  <script src="<?=STATIC_SERVER."functions/$Script.js?v=$ScriptStats[mtime]"?>"
    ...
    integrity="<?="$ScriptStats[algo]-$ScriptStats[hash]"?>"
    <?=$Async?>%pcs-comment-end#* />
  </script>
  <?php
}
      ...
      <div id="menu">
        <ul>
          ...
          <li id="nav_irc" <?=
            ...
            <a href="https://join.slack.com/t/biotorrents/shared_invite/<?=SLACK_INVITE?>"
